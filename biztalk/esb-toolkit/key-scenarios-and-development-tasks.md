...
-   [使用动态转换](../esb-toolkit/using-dynamic-transformation.md)  
  
-   [使用 ESB 异常管理](../esb-toolkit/using-esb-exception-management.md)  
  
-   [使用 BizTalk ESB 工具包 Web 服务](../esb-toolkit/using-the-biztalk-esb-toolkit-web-services.md)  
