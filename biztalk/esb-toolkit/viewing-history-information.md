...
---
# <a name="viewing-history-information"></a>查看历史记录信息
ESB 管理门户维护对通用、 描述、 发现和集成 (UDDI) 注册的所有请求的历史记录。 管理员可以查看在门户内的此列表。  
  
### <a name="to-view-uddi-request-history"></a>若要查看 UDDI 请求历史记录  
