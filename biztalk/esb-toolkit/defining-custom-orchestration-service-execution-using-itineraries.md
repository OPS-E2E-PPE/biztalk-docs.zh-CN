 ...
 **定义自定义业务流程服务执行使用路线**  
 ...
 附带路线入口示例[!INCLUDE[esbToolkit](../includes/esbtoolkit-md.md)]演示此用例。 它演示如何创建路线包含解析，路由，并作为一系列路线步骤定义服务调用说明如何 ESB 和[!INCLUDE[prague](../includes/prague-md.md)]将处理输入的消息。 单向请求响应示例中还包括。  
