...
-   [如何为参与方解析配置证书](~/technical-guides/how-to-configure-certificates-for-party-resolution.md)  
  
-   [如何将证书添加到应用程序](~/technical-guides/how-to-add-certificates-to-an-application.md)