...
|检查事件日志中的错误和警告 （管理检查）。|[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]错误和警告事件保存在应用程序日志中。 事件源，则"[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]。"|  
