...
##  <span data-ttu-id="fe33f-135"><a name="BKMK_BTSGrp"></a>确保多个服务器是 BizTalk 组的一部分</span><span class="sxs-lookup"><span data-stu-id="fe33f-135"><a name="BKMK_BTSGrp"></a> Ensuring Multiple Servers Are Part of a BizTalk Group</span></span>  
...
##  <span data-ttu-id="fe33f-162"><a name="BKMK_Related"></a> 相关章节</span><span class="sxs-lookup"><span data-stu-id="fe33f-162"><a name="BKMK_Related"></a> Related Sections</span></span>  
