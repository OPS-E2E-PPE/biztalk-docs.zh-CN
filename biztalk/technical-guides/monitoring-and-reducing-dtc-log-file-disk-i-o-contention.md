...
## <a name="troubleshooting-dtc"></a>故障排除 DTC  
 有关疑难解答 DTC 信息，请参阅"使用 MSDTC 疑难解答问题"中[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]在帮助[http://go.microsoft.com/fwlink/?LinkId=153237](http://go.microsoft.com/fwlink/?LinkId=153237)。  
