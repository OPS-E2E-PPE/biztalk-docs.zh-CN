...
有多个可用于对 BizTalk Server 管理包问题进行故障排除的操作：  
  
-   请确保正确安装 Operations Manager。  
  
-   请确保正确设置 Operations Manager 配置设置。  
  
-   验证已完成成功导入的管理包。  
  
-   请确保已启用所有相关实体，如规则和监视器。  
  
-   请确保计算机组都填入正确的计算机。 可以使用**创作**模式**组**控制台来执行此检查中的节点。  
  
-   确保所有 SCOM 代理正常。  
  
-   请确保已正确设置检测信号间隔并将规则传播到 Operations Manager 2007 R2/2012年代理计算机。  
