...
- **测试恢复使用日志传送的 BizTalk Server 数据库。**  
   ...
   应遵循以提高可用性的步骤的清单[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]环境中使用灾难恢复，请参阅[核对清单：提供高可用性灾难恢复](../technical-guides/checklist-increasing-availability-with-disaster-recovery.md)。  
