...
---
# <a name="working-with-the-configuration-framework"></a><span data-ttu-id="4c086-102">使用配置框架</span><span class="sxs-lookup"><span data-stu-id="4c086-102">Working with the Configuration Framework</span></span>
<span data-ttu-id="4c086-103">通过配置框架，可在安装时轻松快速地更改 Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 配置。</span><span class="sxs-lookup"><span data-stu-id="4c086-103">The Configuration Framework enables you to quickly and easily change Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] configuration at setup.</span></span> <span data-ttu-id="4c086-104">通过与 Microsoft Windows Installer (MSI) 结合使用，配置框架可以读取并报告计算机的状态和需要操作的配置任务。</span><span class="sxs-lookup"><span data-stu-id="4c086-104">In conjunction with the Microsoft Windows Installer (MSI), the Configuration Framework reads and reports the state of your computer and the configuration tasks requiring action.</span></span>  
  
 <span data-ttu-id="4c086-105">在使用配置向导首次配置 BizTalk Server 时，配置框架将生成一个 XML 文件（配置快照），您随后可对该文件进行修改（即更改用户名、密码等）并将其导出到其他计算机。</span><span class="sxs-lookup"><span data-stu-id="4c086-105">When you configure BizTalk Server for the first time using the Configuration Wizard, the Configuration Framework generates an XML file (a configuration snapshot) that you can then modify (that is, change user names, passwords, and so on) and export to other computers.</span></span> <span data-ttu-id="4c086-106">您可在“配置摘要”页（配置向导的一部分）上保存配置快照。</span><span class="sxs-lookup"><span data-stu-id="4c086-106">You save your configuration snapshot on the Configuration Summary page, part of the Configuration Wizard.</span></span> <span data-ttu-id="4c086-107">您还可使用此快照将配置作为脚本安装的一部分进行复制。</span><span class="sxs-lookup"><span data-stu-id="4c086-107">You can use this snapshot to replicate your configuration as part of a scripted installation.</span></span> <span data-ttu-id="4c086-108">此文件位于\< *BizTalk 安装路径*> \ConfigMain.xml。</span><span class="sxs-lookup"><span data-stu-id="4c086-108">This file is located at \<*BizTalk Installation Path*>\ConfigMain.xml.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="4c086-109">该 XML 文件中不存储密码。</span><span class="sxs-lookup"><span data-stu-id="4c086-109">Passwords are not stored in the XML file.</span></span> <span data-ttu-id="4c086-110">使用此文件之前，必须输入密码。</span><span class="sxs-lookup"><span data-stu-id="4c086-110">You must enter any passwords before you use this file.</span></span>  
  
## <a name="configuration-framework-command-line-parameters"></a><span data-ttu-id="4c086-111">配置框架命令行参数</span><span class="sxs-lookup"><span data-stu-id="4c086-111">Configuration Framework Command Line Parameters</span></span>  
 <span data-ttu-id="4c086-112">下表说明了可以在配置框架中通过命令行运行的参数：</span><span class="sxs-lookup"><span data-stu-id="4c086-112">The following table describes the parameters you can run on the command line within the Configuration Framework.</span></span>  
  
|<span data-ttu-id="4c086-113">命令行参数</span><span class="sxs-lookup"><span data-stu-id="4c086-113">Command Line Parameter</span></span>|<span data-ttu-id="4c086-114">说明</span><span class="sxs-lookup"><span data-stu-id="4c086-114">Description</span></span>|  
|----------------------------|-----------------|  
|<span data-ttu-id="4c086-115">**/U**</span><span class="sxs-lookup"><span data-stu-id="4c086-115">**/U**</span></span>|<span data-ttu-id="4c086-116">取消对所有功能的配置。</span><span class="sxs-lookup"><span data-stu-id="4c086-116">Unconfigures all features.</span></span> <span data-ttu-id="4c086-117">**注意：**取消对 BizTalk Server 功能的配置后，可删除 BizTalk Server 数据库。</span><span class="sxs-lookup"><span data-stu-id="4c086-117">**Note:**  You can delete BizTalk Server databases after you unconfigure BizTalk Server features.</span></span> <span data-ttu-id="4c086-118">请不要在运行此命令之前删除 BizTalk Server 数据库。</span><span class="sxs-lookup"><span data-stu-id="4c086-118">Do not delete BizTalk Server databases before you run this command.</span></span> <span data-ttu-id="4c086-119">**注意：**如果要在取消对 BizTalk Server 功能的配置后，删除 BizTalk Server 数据库，建议使用  **net stop winmgmt** 命令停止可能仍在运行的 Windows 管理规范 (WMI) 服务。</span><span class="sxs-lookup"><span data-stu-id="4c086-119">**Note:**  If you want to delete BizTalk Server databases after you unconfigure BizTalk Server features, we recommend that you use the **net stop winmgmt** command to stop the Windows Management Instrumentation (WMI) service, which may still be running.</span></span>|  
|<span data-ttu-id="4c086-120">**/S**</span><span class="sxs-lookup"><span data-stu-id="4c086-120">**/S**</span></span>|<span data-ttu-id="4c086-121">无提示配置。</span><span class="sxs-lookup"><span data-stu-id="4c086-121">Silent configuration.</span></span><br /><br /> <span data-ttu-id="4c086-122">您还必须提供包含要安装和配置的功能的配置 XML 的完整路径。</span><span class="sxs-lookup"><span data-stu-id="4c086-122">You must also pass the full path to the configuration XML that contains the features to install and configure.</span></span> <span data-ttu-id="4c086-123">如果没有传递 **/s**，则该工具将以用户界面 (UI) 模式运行。</span><span class="sxs-lookup"><span data-stu-id="4c086-123">If **/s** is not passed, the tool runs in User Interface (UI) mode.</span></span>|  
|<span data-ttu-id="4c086-124">**/L**</span><span class="sxs-lookup"><span data-stu-id="4c086-124">**/L**</span></span>|<span data-ttu-id="4c086-125">-   设置日志文件的完整路径（可选）。</span><span class="sxs-lookup"><span data-stu-id="4c086-125">-   Sets the full path to the log file (optional).</span></span>|  
|<span data-ttu-id="4c086-126">**/H**</span><span class="sxs-lookup"><span data-stu-id="4c086-126">**/H**</span></span>|<span data-ttu-id="4c086-127">-   显示有效的命令行参数。</span><span class="sxs-lookup"><span data-stu-id="4c086-127">-   Shows the valid command line parameters.</span></span>|  
  
## <a name="sample-configuration-xml-file"></a><span data-ttu-id="4c086-128">示例配置 XML 文件</span><span class="sxs-lookup"><span data-stu-id="4c086-128">Sample Configuration XML File</span></span>  
 <span data-ttu-id="4c086-129">下面是一个示例配置 XML 文件，其中安装了所有功能。</span><span class="sxs-lookup"><span data-stu-id="4c086-129">The following is a sample configuration XML file with all features installed.</span></span> <span data-ttu-id="4c086-130">若要创建自己的配置文件，请使用 [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 上的自定义配置选项，确认所有组件已成功完成，然后在“配置”窗口中，选择“导出配置”。</span><span class="sxs-lookup"><span data-stu-id="4c086-130">To create your own configuration file, use the Custom configuration option on a [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)], confirm all the components complete successfully, and then choose **Export Configuration** in the Configuration window.</span></span> <span data-ttu-id="4c086-131">然后可使用导出的配置文件来配置其他的 [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]。</span><span class="sxs-lookup"><span data-stu-id="4c086-131">You can then use the exported configuration file to configure other [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]s.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="4c086-132">另请参阅</span><span class="sxs-lookup"><span data-stu-id="4c086-132">See Also</span></span>  
 [<span data-ttu-id="4c086-133">配置 BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="4c086-133">Configure BizTalk Server</span></span>](../install-and-config-guides/configure-biztalk-server.md)   