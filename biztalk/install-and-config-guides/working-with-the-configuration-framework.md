...
---
# <a name="working-with-the-configuration-framework"></a><span data-ttu-id="72c19-102">使用配置框架</span><span class="sxs-lookup"><span data-stu-id="72c19-102">Working with the Configuration Framework</span></span>
<span data-ttu-id="72c19-103">配置框架使你能够快速轻松地更改 Microsoft[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]安装时配置。</span><span class="sxs-lookup"><span data-stu-id="72c19-103">The Configuration Framework enables you to quickly and easily change Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] configuration at setup.</span></span> <span data-ttu-id="72c19-104">使用 Microsoft Windows Installer (MSI) 结合使用，配置框架读取并报告的计算机和请求操作的配置任务的状态。</span><span class="sxs-lookup"><span data-stu-id="72c19-104">In conjunction with the Microsoft Windows Installer (MSI), the Configuration Framework reads and reports the state of your computer and the configuration tasks requiring action.</span></span>  
  
 <span data-ttu-id="72c19-105">当首次使用配置向导配置 BizTalk Server 时，配置框架将生成一个 XML 文件 （配置快照），然后，可以修改 （即，更改用户名、 密码等） 并将导出到其他计算机。</span><span class="sxs-lookup"><span data-stu-id="72c19-105">When you configure BizTalk Server for the first time using the Configuration Wizard, the Configuration Framework generates an XML file (a configuration snapshot) that you can then modify (that is, change user names, passwords, and so on) and export to other computers.</span></span> <span data-ttu-id="72c19-106">在配置摘要页上，配置向导的一部分保存配置快照。</span><span class="sxs-lookup"><span data-stu-id="72c19-106">You save your configuration snapshot on the Configuration Summary page, part of the Configuration Wizard.</span></span> <span data-ttu-id="72c19-107">此快照可用于复制你的配置作为脚本化安装的一部分。</span><span class="sxs-lookup"><span data-stu-id="72c19-107">You can use this snapshot to replicate your configuration as part of a scripted installation.</span></span> <span data-ttu-id="72c19-108">此文件位于\< *BizTalk 安装路径*\>\ConfigMain.xml。</span><span class="sxs-lookup"><span data-stu-id="72c19-108">This file is located at \<*BizTalk Installation Path*\>\ConfigMain.xml.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="72c19-109">密码未存储在 XML 文件。</span><span class="sxs-lookup"><span data-stu-id="72c19-109">Passwords are not stored in the XML file.</span></span> <span data-ttu-id="72c19-110">使用此文件之前，必须输入密码。</span><span class="sxs-lookup"><span data-stu-id="72c19-110">You must enter any passwords before you use this file.</span></span>  
  
## <a name="configuration-framework-command-line-parameters"></a><span data-ttu-id="72c19-111">配置框架命令行参数</span><span class="sxs-lookup"><span data-stu-id="72c19-111">Configuration Framework Command Line Parameters</span></span>  
 <span data-ttu-id="72c19-112">下表介绍可以在配置框架中通过命令行运行的参数。</span><span class="sxs-lookup"><span data-stu-id="72c19-112">The following table describes the parameters you can run on the command line within the Configuration Framework.</span></span>  
  
|<span data-ttu-id="72c19-113">命令行参数</span><span class="sxs-lookup"><span data-stu-id="72c19-113">Command Line Parameter</span></span>|<span data-ttu-id="72c19-114">Description</span><span class="sxs-lookup"><span data-stu-id="72c19-114">Description</span></span>|  
|----------------------------|-----------------|  
|<span data-ttu-id="72c19-115">**/U**</span><span class="sxs-lookup"><span data-stu-id="72c19-115">**/U**</span></span>|<span data-ttu-id="72c19-116">0}run 所有功能。</span><span class="sxs-lookup"><span data-stu-id="72c19-116">Unconfigures all features.</span></span> <span data-ttu-id="72c19-117">**注意：** 取消对 BizTalk Server 功能后，您可以删除 BizTalk Server 数据库。</span><span class="sxs-lookup"><span data-stu-id="72c19-117">**Note:**  You can delete BizTalk Server databases after you unconfigure BizTalk Server features.</span></span> <span data-ttu-id="72c19-118">不要删除在运行此命令之前的 BizTalk Server 数据库。</span><span class="sxs-lookup"><span data-stu-id="72c19-118">Do not delete BizTalk Server databases before you run this command.</span></span> <span data-ttu-id="72c19-119">**注意：** 如果你想要删除 BizTalk Server 数据库后取消对 BizTalk Server 功能，我们建议你使用**net stop winmgmt**命令来停止可能仍是 Windows Management Instrumentation (WMI) 服务正在运行。</span><span class="sxs-lookup"><span data-stu-id="72c19-119">**Note:**  If you want to delete BizTalk Server databases after you unconfigure BizTalk Server features, we recommend that you use the **net stop winmgmt** command to stop the Windows Management Instrumentation (WMI) service, which may still be running.</span></span>|  
|<span data-ttu-id="72c19-120">**/S**</span><span class="sxs-lookup"><span data-stu-id="72c19-120">**/S**</span></span>|<span data-ttu-id="72c19-121">无提示配置。</span><span class="sxs-lookup"><span data-stu-id="72c19-121">Silent configuration.</span></span><br /><br /> <span data-ttu-id="72c19-122">您还必须将的完整路径传递给配置 XML，其中包含要安装和配置的功能。</span><span class="sxs-lookup"><span data-stu-id="72c19-122">You must also pass the full path to the configuration XML that contains the features to install and configure.</span></span> <span data-ttu-id="72c19-123">如果 **/s**未传递，在用户界面 (UI) 模式下运行工具。</span><span class="sxs-lookup"><span data-stu-id="72c19-123">If **/s** is not passed, the tool runs in User Interface (UI) mode.</span></span>|  
|<span data-ttu-id="72c19-124">**/L**</span><span class="sxs-lookup"><span data-stu-id="72c19-124">**/L**</span></span>|<span data-ttu-id="72c19-125">-设置的完整路径的日志文件 （可选）。</span><span class="sxs-lookup"><span data-stu-id="72c19-125">-   Sets the full path to the log file (optional).</span></span>|  
|<span data-ttu-id="72c19-126">**/H**</span><span class="sxs-lookup"><span data-stu-id="72c19-126">**/H**</span></span>|<span data-ttu-id="72c19-127">-显示了有效的命令行参数。</span><span class="sxs-lookup"><span data-stu-id="72c19-127">-   Shows the valid command line parameters.</span></span>|  
  
## <a name="sample-configuration-xml-file"></a><span data-ttu-id="72c19-128">示例配置 XML 文件</span><span class="sxs-lookup"><span data-stu-id="72c19-128">Sample Configuration XML File</span></span>  
 <span data-ttu-id="72c19-129">以下是安装所有功能的示例配置 XML 文件。</span><span class="sxs-lookup"><span data-stu-id="72c19-129">The following is a sample configuration XML file with all features installed.</span></span> <span data-ttu-id="72c19-130">若要创建您自己的配置文件，请使用自定义配置选项上[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]，已成功，确认完成的所有组件，然后选择**导出配置**配置窗口中。</span><span class="sxs-lookup"><span data-stu-id="72c19-130">To create your own configuration file, use the Custom configuration option on a [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)], confirm all the components complete successfully, and then choose **Export Configuration** in the Configuration window.</span></span> <span data-ttu-id="72c19-131">然后可以使用导出的配置文件来配置其他[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]s。</span><span class="sxs-lookup"><span data-stu-id="72c19-131">You can then use the exported configuration file to configure other [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]s.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="72c19-132">请参阅</span><span class="sxs-lookup"><span data-stu-id="72c19-132">See Also</span></span>  
 [<span data-ttu-id="72c19-133">配置 BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="72c19-133">Configure BizTalk Server</span></span>](../install-and-config-guides/configure-biztalk-server.md)   