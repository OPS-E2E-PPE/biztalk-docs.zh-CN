...
---
# <a name="how-to-enable-a-receive-location"></a>如何启用接收位置
本主题介绍如何使用 BizTalk Server 管理控制台来启用接收位置。 接收位置必须在启用后才能接收消息。  
  
 有关创建接收位置的说明，请参阅[如何创建接收位置](../core/how-to-create-a-receive-location.md)。  
...
### <a name="to-enable-a-receive-location"></a>若要启用接收位置  
  
1. 单击**启动**，单击**所有程序**，单击[!INCLUDE[btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)]，然后单击**BizTalk Server 管理**。  
  
2. 在控制台树中，展开要为其启用接收位置的 BizTalk 组和 BizTalk 应用程序。  
  
3. 单击**接收位置**，右键单击接收位置，然后单击**启用**。  
