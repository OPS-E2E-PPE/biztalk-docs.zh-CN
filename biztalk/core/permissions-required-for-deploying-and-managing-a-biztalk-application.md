...
##  <a name="BKMK_Permissions_for_deploying"></a><span data-ttu-id="448e2-122">部署 BizTalk 从 Visual Studio 的程序集的权限</span><span class="sxs-lookup"><span data-stu-id="448e2-122">Permissions for deploying BizTalk assemblies from Visual Studio</span></span>  
...
##  <a name="BKMK_Permissions_for_importing"></a><span data-ttu-id="448e2-125">用于导入应用程序的权限</span><span class="sxs-lookup"><span data-stu-id="448e2-125">Permissions for importing an application</span></span>  
...
##  <a name="BKMK_Permissions_for_exporting"></a><span data-ttu-id="448e2-148">导出应用程序的权限</span><span class="sxs-lookup"><span data-stu-id="448e2-148">Permissions for exporting an application</span></span>  
...
##  <a name="BKMK_Permissions_for_installing_an_application"></a><span data-ttu-id="448e2-166">安装应用程序的权限</span><span class="sxs-lookup"><span data-stu-id="448e2-166">Permissions for installing an application</span></span>  
