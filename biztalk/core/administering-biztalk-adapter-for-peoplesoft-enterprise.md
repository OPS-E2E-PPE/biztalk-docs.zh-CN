...
---
# <a name="administering-biztalk-adapter-for-peoplesoft-enterprise"></a>管理 PeopleSoft Enterprise 的 BizTalk 适配器
此部分提供有关管理用于 PeopleSoft Enterprise 的 BizTalk 适配器的信息。  
