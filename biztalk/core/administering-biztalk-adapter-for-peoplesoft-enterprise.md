...
## <a name="in-this-section"></a><span data-ttu-id="561aa-103">本节内容</span><span class="sxs-lookup"><span data-stu-id="561aa-103">In This Section</span></span>  
  
-   [<span data-ttu-id="561aa-104">使用 BizTalk Server 的异常处理</span><span class="sxs-lookup"><span data-stu-id="561aa-104">Using BizTalk Server Exception Handling</span></span>](../core/using-biztalk-server-exception-handling2.md)