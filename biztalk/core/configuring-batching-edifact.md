...
### <a name="to-configure-batching-settings"></a><span data-ttu-id="42f54-110">配置批处理设置</span><span class="sxs-lookup"><span data-stu-id="42f54-110">To configure batching settings</span></span>  
