...
---
# <a name="issuing-a-single-function-request"></a><span data-ttu-id="a6aff-102">发出单函数请求</span><span class="sxs-lookup"><span data-stu-id="a6aff-102">Issuing a Single-Function Request</span></span>
<span data-ttu-id="a6aff-103">下面的 GetEffectiveAddress 示例，是对 JD Edwards EnterpriseOne 的单函数调用和此请求的结果是标准的响应文档。</span><span class="sxs-lookup"><span data-stu-id="a6aff-103">The following example, GetEffectiveAddress, is a single-function call to JD Edwards EnterpriseOne, and the result of this request is a standard response document.</span></span> <span data-ttu-id="a6aff-104">在单函数请求中，指定 XML 对象中的只有一个 callMethod。</span><span class="sxs-lookup"><span data-stu-id="a6aff-104">In a single-function request, only one callMethod within the XML object is specified.</span></span>  
  
## <a name="example-executing-a-business-function-with-a-single-function-call"></a><span data-ttu-id="a6aff-105">例如：执行具有单函数调用的业务函数</span><span class="sxs-lookup"><span data-stu-id="a6aff-105">Example: Executing a Business Function with a Single-Function Call</span></span>  
 <span data-ttu-id="a6aff-106">下面是一个示例 GetEffectiveAddress 请求文档。</span><span class="sxs-lookup"><span data-stu-id="a6aff-106">The following is a sample GetEffectiveAddress request document.</span></span> <span data-ttu-id="a6aff-107">在添加时创建的 XSD 中的 XML 实例生成的项，它是由 BizTalk Server 生成。</span><span class="sxs-lookup"><span data-stu-id="a6aff-107">It is generated by BizTalk Server as an XML instance from the XSD that is created when you add generated items.</span></span> <span data-ttu-id="a6aff-108">此示例请求文档的发送端口配置中使用的 attribute_style 架构生成。</span><span class="sxs-lookup"><span data-stu-id="a6aff-108">This sample request document was generated using the ATTRIBUTE_STYLE schema style in the send port configuration.</span></span>  
  
 <span data-ttu-id="a6aff-109">**请求的 XML 示例**</span><span class="sxs-lookup"><span data-stu-id="a6aff-109">**Request XML Sample**</span></span>  
...
```  
 ...
 <span data-ttu-id="a6aff-110">下面是一个示例 GetEffectiveAddress 响应返回的 j.d.</span><span class="sxs-lookup"><span data-stu-id="a6aff-110">The following is a sample GetEffectiveAddress response returned by J.D.</span></span> <span data-ttu-id="a6aff-111">Edwards EnterpriseOne 作为对 GetEffectiveAddress 请求的回复。</span><span class="sxs-lookup"><span data-stu-id="a6aff-111">Edwards EnterpriseOne as a reply to the GetEffectiveAddress request.</span></span>  
  
 <span data-ttu-id="a6aff-112">**响应 XML 示例**</span><span class="sxs-lookup"><span data-stu-id="a6aff-112">**Response XML Sample**</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="a6aff-113">请参阅</span><span class="sxs-lookup"><span data-stu-id="a6aff-113">See Also</span></span>  
 [<span data-ttu-id="a6aff-114">附录 a:示例文件</span><span class="sxs-lookup"><span data-stu-id="a6aff-114">Appendix A: Sample Files</span></span>](../core/appendix-a-sample-files.md)