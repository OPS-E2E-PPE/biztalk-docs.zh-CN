...
## <a name="example-executing-a-business-function-with-a-single-function-call"></a><span data-ttu-id="b633f-105">示例： 执行单函数调用的业务函数</span><span class="sxs-lookup"><span data-stu-id="b633f-105">Example: Executing a Business Function with a Single-Function Call</span></span>  
 <span data-ttu-id="b633f-106">下面是一个示例 GetEffectiveAddress 请求文档。</span><span class="sxs-lookup"><span data-stu-id="b633f-106">The following is a sample GetEffectiveAddress request document.</span></span> <span data-ttu-id="b633f-107">该文档是 BizTalk Server 将其作为一个 XML 实例从 XSD 生成的，该 XSD 是在您添加所生成项时创建的。</span><span class="sxs-lookup"><span data-stu-id="b633f-107">It is generated by BizTalk Server as an XML instance from the XSD that is created when you add generated items.</span></span> <span data-ttu-id="b633f-108">此示例请求文档是使用发送端口配置中的 ATTRIBUTE_STYLE 架构类型生成的。</span><span class="sxs-lookup"><span data-stu-id="b633f-108">This sample request document was generated using the ATTRIBUTE_STYLE schema style in the send port configuration.</span></span>  
  
 <span data-ttu-id="b633f-109">**请求的 XML 示例**</span><span class="sxs-lookup"><span data-stu-id="b633f-109">**Request XML Sample**</span></span>  
...
```  
 ...
 <span data-ttu-id="b633f-110">下面是 J.D. </span><span class="sxs-lookup"><span data-stu-id="b633f-110">The following is a sample GetEffectiveAddress response returned by J.D.</span></span> <span data-ttu-id="b633f-111">Edwards EnterpriseOne 作为对 GetEffectiveAddress 请求的回复而返回的一个示例 GetEffectiveAddress 响应。</span><span class="sxs-lookup"><span data-stu-id="b633f-111">Edwards EnterpriseOne as a reply to the GetEffectiveAddress request.</span></span>  
  
 <span data-ttu-id="b633f-112">**响应 XML 示例**</span><span class="sxs-lookup"><span data-stu-id="b633f-112">**Response XML Sample**</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="b633f-113">另请参阅</span><span class="sxs-lookup"><span data-stu-id="b633f-113">See Also</span></span>  
 [<span data-ttu-id="b633f-114">附录 a： 示例文件</span><span class="sxs-lookup"><span data-stu-id="b633f-114">Appendix A: Sample Files</span></span>](../core/appendix-a-sample-files.md)