...
上**组中心**页[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]管理控制台中，查询结果窗格中包含列过多的需要进行滚动才能查看它们的信息。 您可以添加或删除窗格中的列，以便只显示所需的信息。 若要添加或删除列，右键单击任何部分查询结果窗格中的单击**添加/删除列**上下文菜单上。  
...
|       程序集版本       |                                                  相关程序集的版本号。                                                  |
|       部署时间        | 将服务实例程序集部署到 [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 的时间。 |
