...
|消息正文|应用程序用户帐户包含一个或多个个人（不是组）帐户。 如果已经从 Active Directory 或本地计算机删除这些个人帐户，则必须立即从 SSO 系统中删除这些帐户，否则它们会成为安全隐患。%r<br /><br /> 应用程序名称: %1 %r<br /><br /> Application Users: %2 %r<br /><br /> 个人帐户： %3|  
