...
3.  在“属性”窗口中，执行以下操作：  
    ...
    |**消息类型**|从下拉列表中，展开**架构**，然后选择**RuleTest.PO**。|  
     ...
     ![BRE &#45;演练 &#45;MsgProps](../core/media/c82cfb67-63f6-4133-95bf-daadac0e213a.gif "c82cfb67-63f6-4133-95bf-daadac0e213a")  
...
6.  指定**文件**为**传输**，键入作为输入的目录的名称和**C:\BRE-Walkthroughs\RuleTestSol\Input\\\*.xml**文件掩码以及 (**\*.xml**) uri。  
...
13. 指定**文件**为**传输**，键入作为输出目录的名称和**C:\BRE-Walkthroughs\RuleTestSol\Output**，和 %MessageID%.xml 作为输出文件名称。  
...
1.  连接**ReceivePOPrt**端口到**ReceivePO**形状。 （将端口图面上 ReceivePOPrt 端口右侧的箭头拖到 ReceivePO 形状上的框。）  
     ...
     ![BRE &#45;演练 &#45;ConnectRP](../core/media/75bdf79e-ca98-43bb-8ff6-5f46005a6490.gif "75bdf79e-ca98-43bb-8ff6-5f46005a6490")  
  
2.  连接**SendPO**形状变为**SendPOPrt**端口。  
  
     ![BRE &#45;演练 &#45;ConnectSP](../core/media/7513f52b-2782-4357-b8eb-1874dec33869.gif "7513f52b-2782-4357-b8eb-1874dec33869")  
...
## <a name="see-also"></a>另请参阅  
 ...
 [调用在业务流程中的业务规则](../core/invoking-business-rules-in-orchestrations.md)