...
本主题介绍如何使用 BizTalk Server 管理控制台或命令行通过 .xml 文件向 BizTalk 组导入绑定。 有关 BizTalk 组中的绑定导出到.xml 文件，可以导入的说明，请参阅[如何为 BizTalk 组导出绑定](../core/how-to-export-bindings-for-a-biztalk-group.md)。  
...
4. 单击绑定文件，然后单击**打开**。  
    ...
    绑定文件中的项目将写入该组。 它们的相应文件夹中显示\<的所有项目\>节点。  
...
2. 键入以下命令，替换适当的值下, 表中所述：  
    ...
    **BTSTask ImportBindings /Source:** *值* **/GroupLevel** [**/Server:**<em>值</em>] [  **/数据库:**<em>值</em>]  
