...
-   [如何创建链接](../core/how-to-create-links.md)  
...
-   [如何复制、 剪切和粘贴链接和 Functoid](../core/how-to-copy-cut-and-paste-links-and-functoids.md)  
  
-   [如何标记链接](../core/how-to-label-a-link.md)  
  
-   [如何选择多个链接和 Functoid](../core/how-to-select-multiple-links-and-functoids.md)  
  
-   [如何在多个链接和 Functoid 上设置标签和注释](../core/how-to-set-label-and-comment-on-multiple-links-and-functoids.md)