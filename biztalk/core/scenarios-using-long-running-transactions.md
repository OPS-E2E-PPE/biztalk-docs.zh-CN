...
## <a name="scenario-1-using-long-running-transactions-with-timeouts"></a>应用场景 1：使用长期事务用于超时  
...
## <a name="scenario-2-using-long-running-transactions-with-custom-compensation"></a>应用场景 2：使用长期事务用于自定义补偿  
