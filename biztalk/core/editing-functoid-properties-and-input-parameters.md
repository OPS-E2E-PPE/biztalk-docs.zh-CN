...
-   [如何配置 Functoid 输入参数](../core/how-to-configure-functoid-input-parameters.md)  
  
-   [如何配置脚本 Functoid](../core/how-to-configure-the-scripting-functoid.md)  
  
-   [如何配置表循环和表提取程序 Functoid](../core/how-to-configure-the-table-looping-and-table-extractor-functoids.md)  
  
-   [如何标签和注释 Functoid](../core/how-to-label-and-comment-a-functoid.md)