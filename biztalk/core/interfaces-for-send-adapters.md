...
---
# <a name="interfaces-for-send-adapters"></a>发送适配器的接口
本部分介绍开发发送适配器时需要实现的接口。  
...
-   [Asynchronous Batch-Supported 发送适配器的接口](../core/interfaces-for-an-asynchronous-batch-supported-send-adapter.md)er  
