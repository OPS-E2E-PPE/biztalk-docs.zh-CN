...
## <a name="pivottable-view"></a>数据透视表视图  
 “数据透视表视图”区域显示您使用用于 Excel 的 BAM 加载项设计的数据透视表。 Office Web 组件使您可以操作数据透视表报表以显示最符合您需求的数据视图...  
...
- Excel 中的数据透视表内包含一个“页”字段，您可以在其中输入时间切片维度。 使用 BAM 门户的 Office Web 组件不包括页字段。 如果 Excel 数据透视表使用“页”字段来表示维度，此字段的数据不显示在 BAM 门户的数据透视表中。  
