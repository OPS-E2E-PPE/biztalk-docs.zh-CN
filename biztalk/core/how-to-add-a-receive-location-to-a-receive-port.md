...
> [!NOTE]
>  你可以将绑定接收端口到业务流程时配置应用程序，如中所述[如何配置应用程序](../core/how-to-configure-an-application.md)或当你绑定业务流程中所述[如何配置绑定业务流程](../core/how-to-configure-bindings-for-an-orchestration.md)。  
...
3.  单击**接收端口**，右键单击你想要添加接收位置，指向接收端口**新建**，然后单击**接收位置**。  
  
4.  在**名称**，键入新接收位置的名称。  
  
5.  通过中的说明配置为接收位置属性[如何创建接收位置](../core/how-to-create-a-receive-location.md)，然后单击**确定**。  
