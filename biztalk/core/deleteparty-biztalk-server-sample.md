...
> [!NOTE]
>  在删除参与方之前，必须先创建一个参与方。 一种办法是运行[PartyResolution （BizTalk Server 示例）](../core/partyresolution-biztalk-server-sample.md)示例。  
...
1.  在[!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)]，打开解决方案文件 DeleteParty.sln。  
