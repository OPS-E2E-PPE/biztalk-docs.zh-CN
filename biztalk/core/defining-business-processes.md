...
## <a name="using-orchestrations"></a>使用业务流程  
 ...
 开发人员创建业务流程依赖于三个主要工具： 用于创建 XML 架构，BizTalk 映射器，用于定义这些架构与指定的业务逻辑的业务流程设计器之间的转换在 BizTalk 编辑器处理。 所有这些工具均以 [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] 为宿主，从而为开发人员提供了一致的环境。 本部分介绍了这其中的每种工具的功能以及这些工具协同工作的方式。  
...
- 业务流程是在 BizTalk Server 中创建业务流程的基础。 但是，业务流程的某些方面可能比其他方面更易变动。 特别是，嵌入到业务流程中的决策（业务规则）最容易发生变化。 管理器的支出限制为 100,000 美元的奖金过去一周，但升迁，这最多 500,000 美元或从 100 个单位的慢速付费客户的最大允许的订单减少至仅有 10。 您可以指定和更新这些规则使用业务规则引擎。  
