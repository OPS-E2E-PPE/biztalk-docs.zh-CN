...
> [!NOTE]
>  <span data-ttu-id="4081e-104">使用的 Web Services 不支持未知 SOAP 标头。</span><span class="sxs-lookup"><span data-stu-id="4081e-104">Consumed Web services do not support unknown SOAP headers.</span></span>  
  
 <span data-ttu-id="4081e-105">已耗用的 Web 服务的 WSDL 列出绑定元素中定义的 SOAP 标头。</span><span class="sxs-lookup"><span data-stu-id="4081e-105">The WSDL for the consumed Web service lists the defined SOAP headers in the binding element.</span></span> <span data-ttu-id="4081e-106">下面的示例演示在使用 Web 服务的 WSDL 文件中的一个绑定元素：</span><span class="sxs-lookup"><span data-stu-id="4081e-106">The following example shows a binding element in the WSDL file for the consumed Web service:</span></span>  
...
```  
 ...
 <span data-ttu-id="4081e-107">有关使用 SOAP 标头的详细信息，请在.NET Framework 文档中参阅"使用 SOAP 标头" [http://go.microsoft.com/fwlink/?LinkId=62266](http://go.microsoft.com/fwlink/?LinkId=62266)。</span><span class="sxs-lookup"><span data-stu-id="4081e-107">For more information about using SOAP headers, see "Using SOAP Headers" in .NET Framework documentation at [http://go.microsoft.com/fwlink/?LinkId=62266](http://go.microsoft.com/fwlink/?LinkId=62266).</span></span>  
  
## <a name="in-this-section"></a><span data-ttu-id="4081e-108">本节内容</span><span class="sxs-lookup"><span data-stu-id="4081e-108">In This Section</span></span>  
  
-   [<span data-ttu-id="4081e-109">使用 SOAP 标头使用的 Web 服务</span><span class="sxs-lookup"><span data-stu-id="4081e-109">Consuming Web Services with SOAP Headers</span></span>](../core/consuming-web-services-with-soap-headers.md)  
  
-   [<span data-ttu-id="4081e-110">在业务流程中使用 SOAP 标头</span><span class="sxs-lookup"><span data-stu-id="4081e-110">Using SOAP Headers in Orchestrations</span></span>](../core/using-soap-headers-in-orchestrations.md)  
  
-   [<span data-ttu-id="4081e-111">在管道组件中使用 SOAP 标头</span><span class="sxs-lookup"><span data-stu-id="4081e-111">Using SOAP Headers in Pipeline Components</span></span>](../core/using-soap-headers-in-pipeline-components.md)