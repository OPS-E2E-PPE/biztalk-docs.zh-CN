...
-   [单一登录的要求](../core/requirements-for-single-sign-on3.md)  
  
-   [用于 TIBCO Rendezvous 的单一登录和 BizTalk 适配器](../core/single-sign-on-and-biztalk-adapter-for-tibco-rendezvous.md)  
