...
5. 在中**SOAP 传输属性**对话框框中，执行以下操作：  
   ...
   |                     使用此选项                      |                                                                                                                                                                                                                                                                                                              执行的操作                                                                                                                                                                                                                                                                                                               |
   |---------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
   | **虚拟目录和 Web 服务.asmx 文件** |                                                                                                                 指示由 BizTalk Web Services 发布向导创建的 .asmx 文件。<br /><br /> 此消息的格式类似于以下格式：<br /><br /> /PurchaseOrder/POOrchestration.asmx<br /><br /> 其中，.asmx 文件的完整位置是http://localhost/PurchaseOrder/POOrchestration.asmx。 **注意：** 的 URI 发送端口或接收位置不能超过 256 个字符。                                                                                                                 |
