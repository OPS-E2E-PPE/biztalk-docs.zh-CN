...
本部分介绍的信息面向想要创建 BizTalk Server 应用程序和使用 BizTalk Server 的开发人员。 创建这些应用程序后，它们通常管理使用信息在中找到的管理员[TIBCO 企业消息服务用于管理 BizTalk Adapter](../core/administering-biztalk-adapter-for-tibco-enterprise-message-service.md)部分。  
