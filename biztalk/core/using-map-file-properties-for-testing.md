...
---
# <a name="using-map-file-properties-for-testing"></a>使用地图文件属性进行测试
...
-   输入和输出测试实例的格式  
 ...
 有关地图属性的信息，请参阅**映射属性引用** [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)]。
