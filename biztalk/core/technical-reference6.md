---
title: 适用于 JD Edwards EnterpriseOne 示例文件和数据类型 |Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
ms.locfileid: "65299756"
---
# <a name="technical-reference"></a>技术参考
本部分提供用于 JD Edwards EnterpriseOne 的 Microsoft BizTalk 适配器的技术参考信息。  
