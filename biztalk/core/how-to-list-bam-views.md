---
title: 如何列出 BAM 视图 |Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
ms.locfileid: "37015670"
---
# <a name="how-to-list-bam-views"></a>如何列出 BAM 视图
管理员使用**get 视图**命令以列出在其运行该命令的计算机上的 BAM 主导入数据库中部署的 BAM 视图。  
  
### <a name="to-list-bam-views"></a>列出 BAM 视图  
