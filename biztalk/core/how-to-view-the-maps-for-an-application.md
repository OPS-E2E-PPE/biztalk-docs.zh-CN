...
---
# <a name="how-to-view-the-maps-for-an-application"></a>如何为应用程序中查看地图
本主题介绍如何使用 BizTalk Server 管理控制台查看 BizTalk 应用程序中包含的映射。  
...
### <a name="to-view-the-maps-for-an-application"></a>若要查看应用程序映射  
  
1.  单击**启动**，单击**所有程序**，单击[!INCLUDE[btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)]，然后单击**BizTalk Server 管理**。  
  
2.  在控制台树中，展开**BizTalk Server 管理**，展开包含该应用程序想要查看其地图的 BizTalk 组，然后展开应用程序。  
