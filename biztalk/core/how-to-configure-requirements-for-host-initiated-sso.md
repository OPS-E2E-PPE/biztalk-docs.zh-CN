...
2.  验证功能级别是否**Windows Server 2008**。 如果不是，请参阅 Active Directory 文档，然后尝试更改该设置。  
...
4. 在命令行上，转至企业单一登录安装目录。 默认值是\<驱动器\>: \Program Files\Common Files\Enterprise Single Sign-on。  
