...
|  消息正文   | 此应用程序的应用程序管理员帐户无效。 如果是本地帐户，请检查服务器上是否存在此帐户。 如果是域帐户，请与域管理员联系。 当帐户有效时，启用应用程序。 如果您不打算在此计算机上使用此应用程序，则可以忽略此消息。<br /><br /> 应用程序名称: %1 %r<br /><br /> 应用程序管理员: %2 %r<br /><br /> 无效帐户: %3 %r<br /><br /> 错误代码： %4 |
