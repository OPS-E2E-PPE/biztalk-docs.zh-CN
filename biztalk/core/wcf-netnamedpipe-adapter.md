---
title: WCF NetNamedPipe 适配器 |Microsoft 文档
ms.custom: ''
ms.date: 06/08/2017
...
## <a name="in-this-section"></a><span data-ttu-id="fcbb2-105">本节内容</span><span class="sxs-lookup"><span data-stu-id="fcbb2-105">In This Section</span></span>  
  
-   [<span data-ttu-id="fcbb2-106">什么是 WCF NetNamedPipe 适配器？</span><span class="sxs-lookup"><span data-stu-id="fcbb2-106">What Is the WCF-NetNamedPipe Adapter?</span></span>](../core/what-is-the-wcf-netnamedpipe-adapter.md)  
  
-   [<span data-ttu-id="fcbb2-107">配置 WCF NetNamedPipe 适配器</span><span class="sxs-lookup"><span data-stu-id="fcbb2-107">Configuring the WCF-NetNamedPipe Adapter</span></span>](../core/configuring-the-wcf-netnamedpipe-adapter.md)