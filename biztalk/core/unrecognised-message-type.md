...
-   验证下列值定义有效的架构： 对于 X12，目标命名空间、 版本/发行版和文档类型;对于 edifact 而言，目标命名空间、 消息版本号、 消息发行版号和消息类型。 有关详细信息，请参阅 [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 帮助中“接收的 EDI 消息的参与方解析、架构发现和授权”主题的“架构发现”部分。