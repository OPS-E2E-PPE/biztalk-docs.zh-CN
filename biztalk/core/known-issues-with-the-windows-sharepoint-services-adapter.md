...
---
# <a name="known-issues-with-the-windows-sharepoint-services-adapter"></a><span data-ttu-id="f76f0-102">Windows SharePoint Services 适配器的已知的问题</span><span class="sxs-lookup"><span data-stu-id="f76f0-102">Known Issues with the Windows SharePoint Services Adapter</span></span>
<span data-ttu-id="f76f0-103">本部分包含可能帮助您避免错误的信息。</span><span class="sxs-lookup"><span data-stu-id="f76f0-103">This section contains information that may help you avoid errors.</span></span>  
  
## <a name="known-issues"></a><span data-ttu-id="f76f0-104">已知问题</span><span class="sxs-lookup"><span data-stu-id="f76f0-104">Known Issues</span></span>  
  
#### <a name="wss-adapter-fails-to-start-a-workflow-attached-to-a-doc-librarysharepoint-list"></a><span data-ttu-id="f76f0-105">WSS 适配器无法启动工作流附加到文档库 /sharepoint 列表</span><span class="sxs-lookup"><span data-stu-id="f76f0-105">WSS Adapter Fails to Start a Workflow attached to a Doc Library/Sharepoint List</span></span>  
 <span data-ttu-id="f76f0-106">当使用 WSS 适配器从 BizTalk 提交到文档库 /sharepoint 列表的文档或列表项，它无法启动附加到该列表的工作流。</span><span class="sxs-lookup"><span data-stu-id="f76f0-106">When using the WSS Adapter from BizTalk to submit either a document or list item to a Doc Library/Sharepoint List, it fails to start the workflow attached to that List.</span></span> <span data-ttu-id="f76f0-107">解决方法是将以下 XML 代码复制到 \Program Files\Microsoft BizTalk Server 20xx\Business Activity Services\BTSharePointV3AdapterWS\web.config 文件。</span><span class="sxs-lookup"><span data-stu-id="f76f0-107">The workaround is to copy the XML code below into the \Program Files\Microsoft BizTalk Server 20xx\Business Activity Services\BTSharePointV3AdapterWS\web.config file.</span></span>  <span data-ttu-id="f76f0-108">以下 XML 代码必须插入的内部\<配置\>元素。</span><span class="sxs-lookup"><span data-stu-id="f76f0-108">The below XML code must be inserted inside of the \<configuration\> element.</span></span>  
