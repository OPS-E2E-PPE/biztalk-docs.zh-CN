...
1.  在[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]管理控制台中，单击**方**节点下的**BizTalk Server 管理**和**BizTalk 组**节点。 在**方和业务配置文件**页上，单击一个参与方，然后选择具有你想要导出的设置从的协议的业务配置文件。  
