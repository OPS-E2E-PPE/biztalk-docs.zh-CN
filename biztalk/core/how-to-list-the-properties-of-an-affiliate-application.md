...
<span data-ttu-id="c9ac0-103">此命令显示有关关联应用程序的以下信息。</span><span class="sxs-lookup"><span data-stu-id="c9ac0-103">This command shows the following information about the affiliate application.</span></span> <span data-ttu-id="c9ac0-104">有关关联应用程序的属性的详细信息，请参阅[SSO Affiliate 应用程序](../core/sso-affiliate-applications.md)。</span><span class="sxs-lookup"><span data-stu-id="c9ac0-104">For more information about the properties for an affiliate application, see [SSO Affiliate Applications](../core/sso-affiliate-applications.md).</span></span>  
 ...
 <span data-ttu-id="c9ac0-105">SSO 系统从用于更新关联应用程序的 xml 文件获取这些信息。</span><span class="sxs-lookup"><span data-stu-id="c9ac0-105">The SSO system obtains this information from the xml file that you used to update the affiliate application.</span></span> <span data-ttu-id="c9ac0-106">有关详细信息，请参阅[如何更新关联的应用程序的属性](../core/how-to-update-the-properties-of-an-affiliate-application.md)。</span><span class="sxs-lookup"><span data-stu-id="c9ac0-106">For more information, see [How to Update the Properties of an Affiliate Application](../core/how-to-update-the-properties-of-an-affiliate-application.md).</span></span>  
  
### <a name="to-display-the-properties-of-an-affiliate-application-using-the-administration-utility"></a><span data-ttu-id="c9ac0-107">使用管理实用工具显示关联应用程序的属性</span><span class="sxs-lookup"><span data-stu-id="c9ac0-107">To display the properties of an affiliate application using the administration utility</span></span>  
  
1.  <span data-ttu-id="c9ac0-108">上 **启动** 菜单上，单击 **运行**, ，然后键入 **cmd**。</span><span class="sxs-lookup"><span data-stu-id="c9ac0-108">On the **Start** menu, click **Run**, and then type **cmd**.</span></span>  
...
### <a name="to-display-the-properties-of-an-affiliate-application-using-the-client-utility"></a><span data-ttu-id="c9ac0-113">使用客户端实用工具显示关联应用程序的属性</span><span class="sxs-lookup"><span data-stu-id="c9ac0-113">To display the properties of an affiliate application using the client utility</span></span>  
  
1.  <span data-ttu-id="c9ac0-114">上 **启动** 菜单上，单击 **运行**, ，然后键入 **cmd**。</span><span class="sxs-lookup"><span data-stu-id="c9ac0-114">On the **Start** menu, click **Run**, and then type **cmd**.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="c9ac0-119">另请参阅</span><span class="sxs-lookup"><span data-stu-id="c9ac0-119">See Also</span></span>  
 <span data-ttu-id="c9ac0-120">[管理用户映射](../core/managing-user-mappings.md) </span><span class="sxs-lookup"><span data-stu-id="c9ac0-120">[Managing User Mappings](../core/managing-user-mappings.md) </span></span>  
 [<span data-ttu-id="c9ac0-121">管理关联应用程序</span><span class="sxs-lookup"><span data-stu-id="c9ac0-121">Managing Affiliate Applications</span></span>](../core/managing-affiliate-applications.md)