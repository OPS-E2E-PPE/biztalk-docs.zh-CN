...
## <a name="prerequisites"></a>先决条件  
 在配置之前[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]s 针对接收加密的消息，你必须执行中的步骤[如何安装证书的加密消息](../core/how-to-install-the-certificates-for-encrypted-messages.md)。  
...
3.  配置主机用作接收处理程序接收位置与在过程中，安装的解密证书"以接收加密的消息配置 BizTalk 主机"中[如何安装证书的加密消息](../core/how-to-install-the-certificates-for-encrypted-messages.md)。 有关详细信息如何配置主机属性，请参阅[如何修改主机属性](../core/how-to-modify-host-properties.md)。  
