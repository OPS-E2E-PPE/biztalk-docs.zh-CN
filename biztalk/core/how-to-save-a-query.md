...
ms.locfileid: "65334857"
---
# <a name="how-to-save-a-query"></a>如何保存查询
您可以保存查询以备将来重用。 默认情况下，已保存的查询存储在**我的文档**创建并保存它们的用户的文件夹。  
...
4. 创建根据需要，一个查询，然后单击**另存为**。  
  
5. 在中**另存为**对话框框中，浏览到或创建你想要保存查询的文件夹。  
  
6. 在中**文件名**，为该查询中，键入一个名称，然后单击**保存**。  
