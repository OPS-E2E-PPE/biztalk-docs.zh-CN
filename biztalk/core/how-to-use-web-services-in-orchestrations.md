...
## <a name="examples-of-using-web-services"></a>使用 Web Services 示例  
 下面的示例显示几种使用 Web Services 的用法：  
  
-   从下载 SDK 示例"发布和使用 Web 服务 SOAP 标头" [http://go.microsoft.com/fwlink/?LinkId=73703](http://go.microsoft.com/fwlink/?LinkId=73703)。  
  
-   从下载 SDK 示例"使用 Web 服务与数组参数" [http://go.microsoft.com/fwlink/?LinkId=73703](http://go.microsoft.com/fwlink/?LinkId=73703)。  
  
-   下载 SDK 示例"使用 Web 服务"，仅用于消息传递方案示例中，从[http://go.microsoft.com/fwlink/?LinkId=73703](http://go.microsoft.com/fwlink/?LinkId=73703)。  
