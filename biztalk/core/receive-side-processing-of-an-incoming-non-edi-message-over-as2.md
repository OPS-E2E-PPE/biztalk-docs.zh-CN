...
##  <span data-ttu-id="49486-150"><a name="BKMK_NonEDI"></a>处理接收非 EDI 负载</span><span class="sxs-lookup"><span data-stu-id="49486-150"><a name="BKMK_NonEDI"></a> Processing the Received Non-EDI Payload</span></span>  
