...
|    组件    |                                            0                                            |
|  符号名称  |                                            0                                            |
|  消息正文   | 租约超时无效。 有效范围：0 到 23 小时，0-59 分钟和 0 到 59 秒 |
...
#### <a name="to-configure-the-timeout-settings"></a>若要配置的超时设置  
...
9. 在中**连接池设置**部分中，确保**租约超时 （hh: mm:）** 范围是否有效。 可接受的值为 0 到 23 小时，0-59 分钟和 0 到 59 秒。
