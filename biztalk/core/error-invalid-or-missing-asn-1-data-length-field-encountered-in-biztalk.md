...
ms.locfileid: "22241165"
---
# <a name="invalid-or-missing-asn1-data-length-field-encountered-during-decompression-processing"></a>解压缩处理期间 ASN.1 数据长度字段无效或缺失
...
|组件|AS2 引擎|  
|符号名称|-|  
|消息正文|解压缩处理期间 ASN.1 数据长度字段无效或缺失|  
