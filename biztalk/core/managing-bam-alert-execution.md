...
### <a name="modifying-notification-services-configuration-files"></a>修改 Notification Services 配置文件  
 管理员可使用 ProcessBamNSFiles.vbs 脚本更改 Notification Services 传送警报的方式。 Notification Services 的详细信息应用程序定义文件 (ADF)，请参阅[ http://go.microsoft.com/fwlink/?LinkId=127016 ](http://go.microsoft.com/fwlink/?LinkId=127016)。  
