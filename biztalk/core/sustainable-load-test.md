 ...
 **加载可持续的负载测试的配置文件**  
 ...
 ![性能监视器测量可持续负载](../core/media/bts06-sustainable-load.gif "BTS06_Sustainable_Load")  
...
-   SQL 锁指示符下显示良好， **Lock Timeouts/sec**不开始会成为问题之前解决 5000 个 （具体取决于你的 SQL Server) 和锁等待时间低于 1 秒钟还处于正常状态。  
  
 我们已介绍了如何确定最大可承受吞吐量以及可承受、运行状况良好的系统的关键指标，现在，让我们来探讨与接收速度快于处理速度和垃圾回收速度的系统相关联的某些行为。 继续执行[据负载测试以加快](../core/overdrive-load-test.md)。  
