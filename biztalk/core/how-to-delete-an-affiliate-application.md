...
> [!IMPORTANT]
>  当删除关联应用程序时，SSO 系统将自动删除与之关联的所有映射。  
  
> [!IMPORTANT]
>  您必须是 SSO 管理员或 SSO 关联管理员才能执行此任务。  
  
### <a name="to-delete-an-affiliate-application-using-the-mmc-snap-in"></a>若要删除关联应用程序使用 Mmc 管理单元  
...
### <a name="to-delete-an-affiliate-application-using-the-command-line"></a>若要删除关联应用程序使用命令行  
