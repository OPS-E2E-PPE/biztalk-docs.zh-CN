...
|备份 BizTalk 应用程序。|[备份 BizTalk 服务器应用程序](../core/backing-up-biztalk-server-applications.md)|  
...
|如果运行 BizTalk Server 的计算机出现故障，请在替换计算机上安装 BizTalk Server。|[BizTalk Server 2013 和 2013 R2 安装概述](http://msdn.microsoft.com/library/8041926c-cfc9-4eaf-9c28-a2c6e8015bc5)|  
...
|还原 BizTalk 组|[如何恢复 BizTalk 组](../core/how-to-recover-the-biztalk-group.md)<br /><br /> 如果要还原标准版，则必须下载一个有助于恢复服务器的脚本。 下载[RestoreConfig.vbe](http://go.microsoft.com/fwlink/?LinkId=195799)。|  
