...
## <a name="explanation"></a>解释  
 此错误事件表示密码同步适配器已配置需要从外部系统中，旧密码，但未提供旧密码。 可能是外部系统（外部密码同步适配器）未如预期般配置或工作，或者是密码同步适配器配置不正确。 此错误还可能返回错误代码符号名称 ENTSSO_E_REQUIRE_OLD_PASSWORD。  
