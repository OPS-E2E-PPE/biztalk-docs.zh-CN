...
|消息正文|重播 file.%r 中检测到损坏<br /><br /> 重播文件: %1 %r<br /><br /> 其他数据： %2|  
  
## <a name="explanation"></a>解释  
 此错误事件指示 SSO 已重新建立与 SSO 数据库的联系，但无法与相应的进度文件中打开重播文件由于不匹配。 如果 SSO 无法打开重播文件，将会继续执行下一步的重播文件 （如果有）。  
