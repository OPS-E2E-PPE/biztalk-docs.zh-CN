...
ms.locfileid: "22248709"
---
# <a name="how-to-configure-native-pipeline-components"></a><span data-ttu-id="47ca1-102">如何配置本地管道组件</span><span class="sxs-lookup"><span data-stu-id="47ca1-102">How to Configure Native Pipeline Components</span></span>
<span data-ttu-id="47ca1-103">以下代码显示如何使用 `IPersistPropertyBag` 接口配置本地管道组件。</span><span class="sxs-lookup"><span data-stu-id="47ca1-103">The following code shows how to configure native pipeline components using the `IPersistPropertyBag` interface.</span></span>  
