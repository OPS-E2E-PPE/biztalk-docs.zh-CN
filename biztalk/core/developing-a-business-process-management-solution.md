...
---
# <a name="developing-a-business-process-management-solution"></a>开发一个业务流程管理解决方案
本部分介绍在设计解决方案时涉及的基本模式以及如何将这些模式转换为 BizTalk 组件和结构。 此外，本部分还按照消息在解决方案中的处理顺序，提供其他实现详细信息，介绍如何对该解决方案进行版本控制和扩展，并提供消息和文件引用。 有关解决方案和其设计背后的业务要求的详细信息，请参阅"业务要求"中[了解业务流程管理解决方案](../core/understanding-the-business-process-management-solution.md)。  
