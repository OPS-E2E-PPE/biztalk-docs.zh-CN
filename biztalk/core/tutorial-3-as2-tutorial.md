...
8.  MDN 发送端口返回到 MDN \\_MDNToFabrikam 文件夹。 由于这是动态发送端口，将在消息的标头中的回执送达选项行中使用的地址 (**http://localhost/Fabrikam/Default.aspx?目标 = _MDNToFabrikam**) 若要将消息路由到\\_MDNToFabrikam 文件夹。  
...
-   [步骤 2： 创建并部署示例 X12 架构](../core/step-2-create-and-deploy-the-sample-x12-schema.md)  
  
-   [步骤 3： 为你的组织配置方和业务配置文件](../core/step-3-configure-a-party-and-business-profile-for-your-organization2.md)  
  
-   [步骤 4： 为贸易合作伙伴配置方和业务配置文件](../core/step-4-configure-a-party-and-business-profile-for-your-trading-partner2.md)  
