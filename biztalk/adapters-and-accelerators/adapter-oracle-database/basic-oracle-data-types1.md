...
|时间戳 *<br /><br /> （不安全键入如果位于内部 UDT）|化如果 prec < = 7<br />xsd: string 如果 prec > 7|DateTime<br />字符串|时间戳值不能包含时区信息 （UTC 还是基于 UTC 偏移量）：<br /><br /> -化值不能包含 UTC 或 UTC 偏移量<br />-   **DateTime.Kind**必须**DateTimeKind.Unspecified**<br /><br /> 如果指定时区信息，则将引发适配器**XmlReaderParsingException**异常，并附带一条消息，指示该字段。|  
...
|小数 * *|化如果 prec < = 28<br />xsd: string 如果 prec > 28|Decimal<br />字符串|-|  
