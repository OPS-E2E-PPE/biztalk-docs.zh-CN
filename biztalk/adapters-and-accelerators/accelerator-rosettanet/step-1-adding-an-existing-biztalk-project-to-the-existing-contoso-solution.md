...
---
# <a name="step-1-adding-an-existing-biztalk-project-to-the-existing-contoso-solution"></a>步骤 1： 向现有 Contoso 解决方案添加现有 BizTalk 项目
The Microsoft® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] SDK 包含专用业务流程的自定义你自己的专用流程时可作为很好的起点。 在此步骤中，将该业务流程添加到解决方案，然后更改程序集的名称，以避免此名称与 [!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] 安装过程中安装的 PrivateResponder 业务流程相冲突。 在开始之前，打开你在中创建的 Contoso 解决方案[步骤 1： 为 Contoso 价格与可用性请求创建新的 BizTalk 解决方案](../../adapters-and-accelerators/accelerator-rosettanet/step-1-create-new-biztalk-solution-for-contoso-price-and-availability-request.md)。  
