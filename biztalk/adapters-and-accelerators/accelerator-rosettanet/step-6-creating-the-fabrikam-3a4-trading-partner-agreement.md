...
### <a name="to-start-the-btarn-management-console"></a><span data-ttu-id="648e3-105">启动 BTARN 管理控制台</span><span class="sxs-lookup"><span data-stu-id="648e3-105">To start the BTARN Management Console</span></span>  
  
-   <span data-ttu-id="648e3-106">单击**启动**，指向**所有程序**，指向**Microsoft BizTalk\<版本\>Accelerator for RosettaNet**，然后单击**[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** 管理控制台。</span><span class="sxs-lookup"><span data-stu-id="648e3-106">Click **Start**, point to **All Programs**, point to **Microsoft BizTalk \<version\> Accelerator for RosettaNet**, and then click **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** Management Console.</span></span>  
  
### <a name="to-create-the-3a4-trading-partner-agreement"></a><span data-ttu-id="648e3-107">创建 3A4 贸易合作伙伴协议</span><span class="sxs-lookup"><span data-stu-id="648e3-107">To create the 3A4 trading partner agreement</span></span>  
  
1.  <span data-ttu-id="648e3-108">在 **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** 管理控制台中，展开[!INCLUDE[btaBTARNNoVersionui](../../includes/btabtarnnoversionui-md.md)]，右键单击**协议**，指向**新建**，然后单击**协议**.</span><span class="sxs-lookup"><span data-stu-id="648e3-108">In the **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** Management Console, expand [!INCLUDE[btaBTARNNoVersionui](../../includes/btabtarnnoversionui-md.md)], right-click **Agreements**, point to **New**, and then click **Agreement**.</span></span>  
  
2.  <span data-ttu-id="648e3-109">在**新协议属性**对话框中，在**常规**选项卡上，执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="648e3-109">In the **New Agreement Properties** dialog box, on the **General** tab, do the following:</span></span>  
  
    |<span data-ttu-id="648e3-110">使用此选项</span><span class="sxs-lookup"><span data-stu-id="648e3-110">Use this</span></span>|<span data-ttu-id="648e3-111">执行的操作</span><span class="sxs-lookup"><span data-stu-id="648e3-111">To do this</span></span>|  
    |--------------|----------------|  
    |<span data-ttu-id="648e3-112">**名称**</span><span class="sxs-lookup"><span data-stu-id="648e3-112">**Name**</span></span>|<span data-ttu-id="648e3-113">类型**Fabrikam_To_Contoso_3A4**。</span><span class="sxs-lookup"><span data-stu-id="648e3-113">Type **Fabrikam_To_Contoso_3A4**.</span></span>|  
    |<span data-ttu-id="648e3-114">**过程配置**</span><span class="sxs-lookup"><span data-stu-id="648e3-114">**Process Configuration**</span></span>|<span data-ttu-id="648e3-115">选择**STD_3A4_V02.02**从下拉列表。</span><span class="sxs-lookup"><span data-stu-id="648e3-115">Select **STD_3A4_V02.02** from the drop-down list.</span></span>|  
...
3.  <span data-ttu-id="648e3-126">上**端口**选项卡上，执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="648e3-126">On the **Ports** tab, do the following:</span></span>  
    ...
    |<span data-ttu-id="648e3-127">使用此选项</span><span class="sxs-lookup"><span data-stu-id="648e3-127">Use this</span></span>|<span data-ttu-id="648e3-128">执行的操作</span><span class="sxs-lookup"><span data-stu-id="648e3-128">To do this</span></span>|  
    |--------------|----------------|  
    |<span data-ttu-id="648e3-129">**操作 URL**</span><span class="sxs-lookup"><span data-stu-id="648e3-129">**Action URL**</span></span>|<span data-ttu-id="648e3-130">类型**https://<contoso_machine>/BTARNApp/RNIFReceive.aspx**。</span><span class="sxs-lookup"><span data-stu-id="648e3-130">Type **https://<contoso_machine>/BTARNApp/RNIFReceive.aspx**.</span></span>|  
    |<span data-ttu-id="648e3-131">**信号 URL**</span><span class="sxs-lookup"><span data-stu-id="648e3-131">**Signal URL**</span></span>|<span data-ttu-id="648e3-132">类型**https://<contoso_machine>/BTARNApp/RNIFReceive.aspx**。</span><span class="sxs-lookup"><span data-stu-id="648e3-132">Type **https://<contoso_machine>/BTARNApp/RNIFReceive.aspx**.</span></span>|  
    |<span data-ttu-id="648e3-133">**同步 URL**</span><span class="sxs-lookup"><span data-stu-id="648e3-133">**Sync URL**</span></span>|<span data-ttu-id="648e3-134">类型**https://<contoso_machine>/BTARNApp/RNIFReceive.aspx**。</span><span class="sxs-lookup"><span data-stu-id="648e3-134">Type **https://<contoso_machine>/BTARNApp/RNIFReceive.aspx**.</span></span>|  
  
4.  <span data-ttu-id="648e3-135">单击 **“确定”**。</span><span class="sxs-lookup"><span data-stu-id="648e3-135">Click **OK**.</span></span>  
  
5.  <span data-ttu-id="648e3-136">右键单击**Fabrikam_To_Contoso_3A4**协议，然后单击**激活**。</span><span class="sxs-lookup"><span data-stu-id="648e3-136">Right-click the **Fabrikam_To_Contoso_3A4** agreement and then click **Activate**.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="648e3-137">另请参阅</span><span class="sxs-lookup"><span data-stu-id="648e3-137">See Also</span></span>  
 [<span data-ttu-id="648e3-138">步骤 7：生成和部署 LOBWebApplication SDK 示例</span><span class="sxs-lookup"><span data-stu-id="648e3-138">Step 7: Building and Deploying the LOBWebApplication SDK Sample</span></span>](../../adapters-and-accelerators/accelerator-rosettanet/step-7-building-and-deploying-the-lobwebapplication-sdk-sample.md)