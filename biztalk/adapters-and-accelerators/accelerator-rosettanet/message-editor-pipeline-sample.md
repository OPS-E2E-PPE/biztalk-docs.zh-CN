...
此示例演示如何通过向接收管道添加自定义组件来修改传入消息的内容。  
 ...
 此示例是可从[!INCLUDE[btsCoName](../../includes/btsconame-md.md)][!INCLUDE[btaBTARNNoVersion](../../includes/btabtarnnoversion-md.md)]网站，网址[http://go.microsoft.com/fwlink/?LinkId=37877](http://go.microsoft.com/fwlink/?LinkId=37467)。  
