...
ApplicationAdapter 示例演示如何在接收消息时从响应方或发起方的公用流程和专用流程发送通知。 你可以自定义该示例，使其具有任何你需要的其他功能。  
 ...
 通过在输入程序集名称和类名设置为协议 ApplicationAdapter**常规**Microsoft® 中的协议选项卡[!INCLUDE[btaBTARNNoVersion](../../includes/btabtarnnoversion-md.md)]([!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)]) 管理控制台。 应用程序适配器 .dll 文件运行所用的凭据与 BizTalk 主机服务的凭据相同。  
