...
---
# <a name="double-action-tutorial"></a>双操作教程
本教程介绍如何使用 Microsoft® 的端到端解决方案[!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)]。 本教程详述了通过在两个虚构的公司：Contoso（供应商组织）和 Fabrikam（买方组织）之间创建贸易合作伙伴方案来实现 RosettaNet 兼容解决方案时，应该遵循的步骤。  
...
-   [准备双操作教程](../../adapters-and-accelerators/accelerator-rosettanet/preparing-for-the-double-action-tutorial.md)  
