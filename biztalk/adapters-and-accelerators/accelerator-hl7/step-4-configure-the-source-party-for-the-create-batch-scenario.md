...
> [!NOTE]
>  在此方案中，你可以使用你在中创建的同一个源参与方[步骤 7： 创建和配置源参与方](../../adapters-and-accelerators/accelerator-hl7/step-7-create-and-configure-a-source-party.md)的 （零碎的入站批处理方案） 本教程的第 1 部分。  
