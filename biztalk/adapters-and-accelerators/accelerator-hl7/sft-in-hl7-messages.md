...
## <a name="message-instance-with-sft-segment"></a><span data-ttu-id="a6b91-107">使用 SFT 段消息实例</span><span class="sxs-lookup"><span data-stu-id="a6b91-107">Message instance with SFT segment</span></span>  
 <span data-ttu-id="a6b91-108">使用以下过程来创建一个 ADT^A01.txt 消息具有一个 SFT 段。</span><span class="sxs-lookup"><span data-stu-id="a6b91-108">Use the following procedure to create an ADT^A01.txt message with an SFT segment.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="a6b91-109">当你在记事本中创建此消息时，删除回车符后的最后一行。</span><span class="sxs-lookup"><span data-stu-id="a6b91-109">When you create this message in Notepad, delete the carriage return following the last line.</span></span>  
  
#### <a name="to-create-an-adta01txt-message-with-an-sft-segment"></a><span data-ttu-id="a6b91-110">若要创建一个 ADT^A01.txt 消息具有一个 SFT 段</span><span class="sxs-lookup"><span data-stu-id="a6b91-110">To create an ADT^A01.txt message with an SFT segment</span></span>  
  
1.  <span data-ttu-id="a6b91-111">打开记事本。</span><span class="sxs-lookup"><span data-stu-id="a6b91-111">Open Notepad.</span></span>  
  
2.  <span data-ttu-id="a6b91-112">将以下文本复制到记事本：</span><span class="sxs-lookup"><span data-stu-id="a6b91-112">Copy the following text into Notepad:</span></span>  
...
3.  <span data-ttu-id="a6b91-113">保存该文件，然后关闭记事本。</span><span class="sxs-lookup"><span data-stu-id="a6b91-113">Save the file, and then close Notepad.</span></span>  
  
4.  <span data-ttu-id="a6b91-114">检查源方的确认文件夹。</span><span class="sxs-lookup"><span data-stu-id="a6b91-114">Check the Acknowledgement folder of the source party.</span></span>  
  
     <span data-ttu-id="a6b91-115">此消息的正文确认包含消息的 SFT 段。</span><span class="sxs-lookup"><span data-stu-id="a6b91-115">The body acknowledgement of this message contains the SFT segments of the message.</span></span> <span data-ttu-id="a6b91-116">个以上的消息 ACK 是：</span><span class="sxs-lookup"><span data-stu-id="a6b91-116">The ACK for the above message is:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="a6b91-117">另请参阅</span><span class="sxs-lookup"><span data-stu-id="a6b91-117">See Also</span></span>  
 <span data-ttu-id="a6b91-118">[HL7 消息传送](../../adapters-and-accelerators/accelerator-hl7/hl7-messaging.md) </span><span class="sxs-lookup"><span data-stu-id="a6b91-118">[HL7 Messaging](../../adapters-and-accelerators/accelerator-hl7/hl7-messaging.md) </span></span>  
[<span data-ttu-id="a6b91-119">了解 HL7 快捷键和提供的 BizTalk 工具</span><span class="sxs-lookup"><span data-stu-id="a6b91-119">Learn the HL7 accelerator and the BizTalk tools available</span></span>](../../adapters-and-accelerators/accelerator-hl7/learn-the-hl7-accelerator-and-the-biztalk-tools-available.md)