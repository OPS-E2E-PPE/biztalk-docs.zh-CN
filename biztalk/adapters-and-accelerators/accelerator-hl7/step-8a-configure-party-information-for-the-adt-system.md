...
---
# <a name="step-8a-configure-party-information-for-the-adt-system"></a>步骤 8A： 配置 ADT 系统的当事方信息
...
7.  单击**保存**，然后关闭 BTAHL7 配置资源管理器。  
 ...
 继续执行[步骤 8B： 配置 RX 系统的当事方信息](../../adapters-and-accelerators/accelerator-hl7/step-8b-configure-party-information-for-the-rx-system.md)。