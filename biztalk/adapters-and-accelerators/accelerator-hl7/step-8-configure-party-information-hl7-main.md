...
## <a name="in-this-section"></a>本节内容  
 此步骤包含以下子步骤中，你必须按以下顺序执行这些：  
  
1.  [步骤 8A： 配置 ADT 系统的当事方信息](../../adapters-and-accelerators/accelerator-hl7/step-8a-configure-party-information-for-the-adt-system-hl7-main.md)  
  
2.  [单步 8B： 配置 HI 系统的当事方信息](../../adapters-and-accelerators/accelerator-hl7/step-8b-configure-party-information-for-the-hi-system.md)