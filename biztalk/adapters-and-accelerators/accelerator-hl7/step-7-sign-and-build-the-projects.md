...
4.  在程序集密钥文件对话框中，浏览到  **\<*驱动器*>: \Tutorial\BTAHL7V22Common\key.snk** (在创建[步骤 3： 向程序集分配强名称](../../adapters-and-accelerators/accelerator-hl7/step-3-assign-a-strong-name-to-the-assembly.md))，然后单击**打开**。  
