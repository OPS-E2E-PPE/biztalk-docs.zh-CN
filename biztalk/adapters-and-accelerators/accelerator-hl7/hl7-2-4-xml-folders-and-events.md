...
下表列出由 XML 编码消息的 HL7 版本 2.4 文件夹中安装程序向导创建的子文件夹。 这些子文件夹还包含所使用的架构[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]BizTalk Accelerator for HL7 ([!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]) 若要验证，分析，并序列化此表的事件列中列出的事件。 子文件夹名称描述的这些架构支持的事件的类型。  
...
|财务管理|P01 ~ P06、 P10|  
|观察 Reporting|C01 C12、 P07、 P08、 P09、 R01、 R02、 R04、 R21、 W01、 W02|  
|主文件|M01 M12 MFA|  
|医疗记录/信息管理|T01 T12|  
|计划|S01 S26|  
|患者的引用|I01 I15|  
