...
## <a name="biztalk-mapper"></a>BizTalk Mapper  
 使用 BizTalk 映射器创建和自定义映射，它定义了数据转换。 使用 BizTalk 映射器将映射的入站和出站转换[!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]消息类型。  
  
## <a name="biztalk-orchestration-designer"></a>BizTalk 业务流程设计器  
 使用 BizTalk 业务流程设计器来设计和实施业务流程。  
