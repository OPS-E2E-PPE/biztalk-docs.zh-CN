...
[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]BizTalk Accelerator for HL7 ([!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]) 生成 **tablevalues_*\<版本\>*.xsd * * 文件，以每个 HL7 版本，然后查找根目录下的文件HL7 特定于版本的文件夹。 数据类型的公共架构文件引用的表值常见架构文件。  
