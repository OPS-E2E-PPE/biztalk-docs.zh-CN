...
> [!NOTE]
>  阅读此指南之前，你应该熟悉[!INCLUDE[btsVCSharp](../../includes/btsvcsharp-md.md)]开发， [!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]，和[了解 HL7 快捷键和提供的 BizTalk 工具](../../adapters-and-accelerators/accelerator-hl7/learn-the-hl7-accelerator-and-the-biztalk-tools-available.md)。  
...
-   [使用动态数据验证](../../adapters-and-accelerators/accelerator-hl7/using-dynamic-data-validation.md)  
  
-   [为审核和记录的事件创建 WMI 接收器](../../adapters-and-accelerators/accelerator-hl7/creating-a-wmi-sink-for-auditing-and-logging-events.md)  
