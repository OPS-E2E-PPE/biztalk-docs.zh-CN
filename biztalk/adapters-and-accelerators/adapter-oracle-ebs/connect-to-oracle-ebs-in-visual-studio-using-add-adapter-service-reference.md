...
---
# <a name="connect-to-oracle-e-business-suite-in-visual-studio-using-add-adapter-service-reference-plug-in"></a>连接到 Oracle E-business Suite 在 Visual Studio 中使用添加适配器服务引用插件
若要连接到 Oracle E-business Suite 使用[!INCLUDE[adapteroraclebusinessshort](../../includes/adapteroraclebusinessshort-md.md)]在.NET 编程解决方案中，必须使用[!INCLUDE[addadapterservreflong](../../includes/addadapterservreflong-md.md)]。 本主题说明了如何使用[!INCLUDE[addadapterservrefshort](../../includes/addadapterservrefshort-md.md)]。  

## <a name="connecting-to-oracle-e-business-suite-using-the-add-adapter-service-reference-plug-in"></a>连接到 Oracle E-business Suite 使用添加适配器服务引用插件  
 执行以下步骤连接到 Oracle E-business Suite 使用[!INCLUDE[addadapterservrefshort](../../includes/addadapterservrefshort-md.md)]。  
...
7. 单击 **“连接”**。 建立连接后，连接状态显示为**已连接**。  
    ...
    [!INCLUDE[addadapterservrefshort](../../includes/addadapterservrefshort-md.md)]显示包含在 Oracle E-business Suite 和 Oracle 数据库执行的各种操作的不同节点。 元数据的各种节点的分类方式的详细信息，请参阅[连接到 Visual Studio 中使用添加适配器元数据向导中的 Oracle E-business Suite](../../adapters-and-accelerators/adapter-oracle-ebs/connect-to-oracle-ebs-in-visual-studio-using-add-adapter-metadata-wizard.md)。  
