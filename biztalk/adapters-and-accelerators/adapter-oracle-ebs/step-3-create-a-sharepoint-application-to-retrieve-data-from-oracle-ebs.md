...
##  <a name="SSO"></a><span data-ttu-id="31381-109">在 SharePoint 中创建 SSO 应用程序</span><span class="sxs-lookup"><span data-stu-id="31381-109">Creating an SSO Application in SharePoint</span></span>  
...
##  <a name="SSP"></a><span data-ttu-id="31381-134">创建共享的服务提供程序</span><span class="sxs-lookup"><span data-stu-id="31381-134">Creating a Shared Services Provider</span></span>  
...
##  <a name="Import"></a><span data-ttu-id="31381-141">导入的应用程序定义文件</span><span class="sxs-lookup"><span data-stu-id="31381-141">Importing the Application Definition File</span></span>  
