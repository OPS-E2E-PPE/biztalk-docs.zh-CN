...
## <a name="prerequisites"></a>先决条件  
 在开始此步骤之前，完成[步骤 4:实现 Echo 适配器的元数据浏览处理程序](../../adapters-and-accelerators/wcf-lob-adapter-sdk/step-4-implement-the-metadata-browse-handler-for-the-echo-adapter.md)。 您还必须清楚地了解有关以下类：  
