...
---
# <a name="interact-adapter-server-application"></a>交互适配器服务器应用程序
本部分介绍服务器应用程序请求消息的构成的常规说明。 这些是从服务器端 SNL 传递到服务器应用程序的 XML 文档。 在这种情况下，这些消息将在服务器端执行过的 SWIFTNet 基元的第一部分的特性。  
  
 下图显示服务器的请求消息。  
  
 ![服务器请求消息](../../adapters-and-accelerators/fileact-interact/media/05bf7d1b-199c-4806-be91-32ca013e9af8.gif "05bf7d1b-199c-4806-be91-32ca013e9af8")  
  
 下图显示 SNL 和交互，服务器应用程序之间交换的消息的序列。  
  
 ![交互适配器服务器应用程序](../../adapters-and-accelerators/fileact-interact/media/33edb889-edfa-4e55-842a-e238950327e6.gif "33edb889-edfa-4e55-842a-e238950327e6")  
