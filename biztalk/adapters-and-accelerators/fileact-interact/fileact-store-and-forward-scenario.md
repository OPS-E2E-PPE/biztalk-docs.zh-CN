...
---
# <a name="fileact-store-and-forward-scenario"></a>FileAct 存储和转发方案
在开始此方案中的步骤之前，必须完成[准备使用本教程](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md)。  
