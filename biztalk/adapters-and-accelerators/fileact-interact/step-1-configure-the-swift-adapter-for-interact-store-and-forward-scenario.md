...
### <a name="to-configure-the-swift-adapter"></a><span data-ttu-id="e9f6e-104">若要配置 SWIFT 适配器</span><span class="sxs-lookup"><span data-stu-id="e9f6e-104">To configure the SWIFT adapter</span></span>  
  
1.  <span data-ttu-id="e9f6e-105">启动**BizTalk Server 管理**。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-105">Start **BizTalk Server Administration**.</span></span>  
  
2.  <span data-ttu-id="e9f6e-106">在控制台树中，依次展开 BizTalk Server 管理、 BizTalk 组及展开**平台设置**，展开**适配器**，右键单击**交互**，指向**新建**，然后单击**发送处理程序**。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-106">In the console tree, expand BizTalk Server Administration, expand the BizTalk group, expand **Platform Settings**, expand **Adapter**, right-click **INTERACT**, point to **New**, and then click **Send Handler**.</span></span>  
  
3.  <span data-ttu-id="e9f6e-107">在**交互 – 适配器处理程序属性**对话框中，在**常规**选项卡上，从**主机名**下拉列表中，选择**interacthost**，然后单击**属性**。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-107">In the **INTERACT – Adapter Handler Properties** dialog box, on the **General** tab, from the **Host name** drop-down list, select **interacthost**, and then click **Properties**.</span></span>  
  
4.  <span data-ttu-id="e9f6e-108">在**交互传输属性**对话框中，在**属性**选项卡上，执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="e9f6e-108">In the **INTERACT Transport Properties** dialog box, on the **Properties** tab, do the following:</span></span>  
    ...
    |<span data-ttu-id="e9f6e-127">**用户名**</span><span class="sxs-lookup"><span data-stu-id="e9f6e-127">**Username**</span></span>|<span data-ttu-id="e9f6e-128">键入用于连接到压降的用户名称。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-128">Type the user name you use to connect to SAG.</span></span>|  
  
5.  <span data-ttu-id="e9f6e-129">单击**确定**关闭交互传输属性对话框。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-129">Click **OK** to close the INTERACT Transport Properties dialog box.</span></span>  
  
6.  <span data-ttu-id="e9f6e-130">单击**确定**关闭交互 – 适配器处理程序属性对话框。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-130">Click **OK** to close the INTERACT – Adapter Handler Properties dialog box.</span></span>  
  
7.  <span data-ttu-id="e9f6e-131">在消息框中，单击**确定**，然后重新启动交互主机实例。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-131">In the message box, click **OK**, and then restart the InterAct host instance.</span></span>  
  
8.  <span data-ttu-id="e9f6e-132">重复步骤 1。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-132">Repeat step 1.</span></span>  
  
9. <span data-ttu-id="e9f6e-133">在控制台树中，展开 BizTalk Server 管理中，展开**BizTalk**组中，展开**平台设置**，展开**适配器**，选中交互，打开**BizTalkServerApplication** ，然后单击**属性**。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-133">In the console tree, expand BizTalk Server Administration, expand the **BizTalk** group, expand **Platform Settings**, expand **Adapter**, select INTERACT, open **BizTalkServerApplication** and then, click **Properties**.</span></span>  
  
10. <span data-ttu-id="e9f6e-134">在**交互传输属性**对话框中，在**属性**选项卡上，执行以下操作：</span><span class="sxs-lookup"><span data-stu-id="e9f6e-134">In the **INTERACT Transport Properties** dialog box, on the **Properties** tab, do the following:</span></span>  
    ...
    |<span data-ttu-id="e9f6e-153">**用户名**</span><span class="sxs-lookup"><span data-stu-id="e9f6e-153">**Username**</span></span>|<span data-ttu-id="e9f6e-154">键入用于连接到压降的用户名称。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-154">Type the user name you use to connect to SAG.</span></span>|  
  
11. <span data-ttu-id="e9f6e-155">单击**确定**关闭交互传输属性对话框。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-155">Click **OK** to close the INTERACT Transport Properties dialog box.</span></span>  
  
12. <span data-ttu-id="e9f6e-156">选择**将此项的默认处理**选项。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-156">Select **make this the default handler** option.</span></span>  
  
13. <span data-ttu-id="e9f6e-157">单击**确定**以关闭交互 – 适配器处理程序属性对话框。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-157">Click **OK** to close the INTERACT– Adapter Handler Properties dialog box.</span></span>  
  
14. <span data-ttu-id="e9f6e-158">在消息框中，单击**确定**，然后重新启动**BizTalkServerApplication**主机实例。</span><span class="sxs-lookup"><span data-stu-id="e9f6e-158">In the Message box, click **OK**, and then restart the **BizTalkServerApplication** host instance.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="e9f6e-159">另请参阅</span><span class="sxs-lookup"><span data-stu-id="e9f6e-159">See Also</span></span>  
 <span data-ttu-id="e9f6e-160">[步骤 2： 创建发送端口和接收交互应用商店应用和进 （请求） 方案的端口](../../adapters-and-accelerators/fileact-interact/step-2-create-send-ports-and-receive-ports-for-the-interact-store-and-forward.md) </span><span class="sxs-lookup"><span data-stu-id="e9f6e-160">[Step2: Create Send Ports and Receive Ports for the InterAct Store and Forward (Pull) Scenario](../../adapters-and-accelerators/fileact-interact/step-2-create-send-ports-and-receive-ports-for-the-interact-store-and-forward.md) </span></span>  
 <span data-ttu-id="e9f6e-161">[步骤 3： 创建与交互应用商店应用和向前 （请求） 方案的动态发送端口业务流程](../../adapters-and-accelerators/fileact-interact/step-3-create-orchestration-with-dynamic-send-for-interact-store-and-forward.md) </span><span class="sxs-lookup"><span data-stu-id="e9f6e-161">[Step3: Create an orchestration with  dynamic send port for the InterAct Store and Forward (Pull) Scenario](../../adapters-and-accelerators/fileact-interact/step-3-create-orchestration-with-dynamic-send-for-interact-store-and-forward.md) </span></span>  
 [<span data-ttu-id="e9f6e-162">步骤 4：测试 InterAct 存储和转发（拉取）端到端方案</span><span class="sxs-lookup"><span data-stu-id="e9f6e-162">Step 4: Test the InterAct Store and Forward (Pull) End-to-End Scenario</span></span>](../../adapters-and-accelerators/fileact-interact/step-4-test-the-interact-store-and-forward-pull-end-to-end-scenario.md)