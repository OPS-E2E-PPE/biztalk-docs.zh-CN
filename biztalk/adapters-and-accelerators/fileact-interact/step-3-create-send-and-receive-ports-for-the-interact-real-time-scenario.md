...
---
# <a name="step-3-create-send-and-receive-ports-for-the-interact-real-time-scenario"></a>步骤 3： 创建发送和接收端口交互实时方案
璝惠 BizTalk Server 发送和接收端口和接收位置，请参阅[管理项目](../../core/managing-artifacts.md)BizTalk Server 文档中。  
  
## <a name="steps-in-this-section"></a>本部分中的步骤
