...
ms.locfileid: "22223237"
---
# <a name="swift-send-adapter-initialization"></a>SWIFT 发送适配器初始化
在将消息发送到 SWIFT 之前, 必须初始化发送适配器。 下图显示初始化序列。  
  
 ![发送适配器初始化序列](../../adapters-and-accelerators/fileact-interact/media/1e395167-21e7-4f1e-b2da-d7f0f57cd0f8.gif "1e395167-21e7-4f1e-b2da-d7f0f57cd0f8")  
