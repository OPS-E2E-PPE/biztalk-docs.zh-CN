...
|        “属性”        |                                                                                                                                                                                                                            Description                                                                                                                                                                                                                             |
|--------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **GetSchemaTable** | 返回`DataTable`描述列元数据的`DbDataReader`。 支持的架构列特性[!INCLUDE[adoprovidersiebelshort](../../includes/adoprovidersiebelshort-md.md)]是：<br /><br /> -   ColumnName<br />-   ColumnOrdinal<br />-   .NET DataType<br />长度<br />精度 （如果可用）<br />-缩放 （如果可用）<br />-   AllowDBNull<br />-   LocalName<br />-扩展 LocalName<br />-Namespace |
|   **GetString**    |                                                                                                                                                                                                 获取指定列的值的实例作为`String`。                                                                                                                                                                                                 |
|    **GetValue**    |                                                                                                                                                                                                 获取指定列的值的实例作为`String`。                                                                                                                                                                                                 |
|    **isDbNull**    |                                                                                                                                                                                       获取一个值，该值指示列是否包含不存在或缺少的值。                                                                                                                                                                                       |
|   **NextResult**   |                                                                                                                                                           Siebel 数据访问接口始终返回单个结果集;此调用因此完全用完当前结果集返回前**false**。                                                                                                                                                           |
|      **读取**      |                                                                                                                                                         将读取器推进到下一条记录结果集中。  它将返回 **，则返回 true**如果成功，并**false**如果读取器向左具有更多的记录。                                                                                                                                                         |
