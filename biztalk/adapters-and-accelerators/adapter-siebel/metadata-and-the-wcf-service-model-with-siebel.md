...
- WCF 客户端类的方法可用于调用服务方法 （操作） 公开的 WCF 服务约定。  
  ...
  有关如何生成目标的操作的 WCF 客户端类以及 svcutil.exe 之间的差异信息并[!INCLUDE[addadapterservrefshort](../../includes/addadapterservrefshort-md.md)]，请参阅[生成 WCF 客户端或 WCF 服务协定为 Siebel 解决方案项目](../../adapters-and-accelerators/adapter-siebel/generate-a-wcf-client-or-a-wcf-service-contract-for-siebel-solution-artifacts.md)  
