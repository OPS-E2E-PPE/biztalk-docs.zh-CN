...
##  <a name="Custom_Web_Part"></a><span data-ttu-id="f0a5b-132">涉及自定义 Web 部件的问题</span><span class="sxs-lookup"><span data-stu-id="f0a5b-132">Issues Involving Custom Web Parts</span></span>  
...
###  <a name="Issue1"></a><span data-ttu-id="f0a5b-156">问题 4： 与 Microsoft Office SharePoint Server 中显示的单个记录限制基于多个值</span><span class="sxs-lookup"><span data-stu-id="f0a5b-156">Issue 4: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
