...
中的第一个[!INCLUDE[adaptersiebel_short](../../includes/adaptersiebel-short-md.md)]教程包含如何在 Microsoft SharePoint 门户网站上显示从 Siebel 系统的数据的分步演示。 第二个[!INCLUDE[adaptersiebel_short](../../includes/adaptersiebel-short-md.md)]教程包含有关如何迁移 BizTalk 项目创建使用以前版本的 Siebel 适配器以使用基于 WCF 的详细的说明[!INCLUDE[adaptersiebel_short](../../includes/adaptersiebel-short-md.md)]。  
 ...
 此外中的主题[开发 BizTalk 服务器应用程序](../../core/developing-biztalk-server-applications.md)部分提供关于如何使用的详细的说明[!INCLUDE[adaptersiebel_short](../../includes/adaptersiebel-short-md.md)]与[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]。  
...
[开始使用 BizTalk 适配器 Siebel 业务应用程序](../../adapters-and-accelerators/adapter-siebel/get-started-with-the-biztalk-adapter-for-siebel-ebusiness-applications.md)