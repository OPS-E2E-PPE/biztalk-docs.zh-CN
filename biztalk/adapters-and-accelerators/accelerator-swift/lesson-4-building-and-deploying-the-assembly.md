...
在本课程中，你可以生成和部署此项目以生成该程序集包含你在前面的课程中创建的架构。 此任务可确保到目前为止创建的工作中没有任何编译错误。  
 ...
 当项目编译为程序集 （DLL 文件）、 [!INCLUDE[btsCoName](../../includes/btsconame-md.md)] [!INCLUDE[A4SWIFT_CurrentVersion_FirstRef](../../includes/a4swift-currentversion-firstref-md.md)]将保存在 DLL \<*驱动器*>: \Program Files\\ [!INCLUDE[btsCoName](../../includes/btsconame-md.md)] BizTalk Accelerator for SWIFT\bin\在项目文件夹内的开发文件夹。  
