...
-   [安装证书](../../adapters-and-accelerators/accelerator-swift/installing-certificates.md)  
  
-   [设置 A4SWIFT 属性](../../adapters-and-accelerators/accelerator-swift/setting-a4swift-properties.md)  
  
-   [添加 A4SWIFT 用户和更新 Windows 组](../../adapters-and-accelerators/accelerator-swift/adding-a4swift-users-and-updating-windows-groups.md)  
  
-   [添加角色和部门](../../adapters-and-accelerators/accelerator-swift/adding-roles-and-departments.md)  
