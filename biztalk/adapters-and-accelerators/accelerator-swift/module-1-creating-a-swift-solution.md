...
### <a name="to-create-a-blank-biztalk-solution"></a>若要创建空的 BizTalk 解决方案  
  
1. 启动**Visual Studio**。  
  
2. 在 **“文件”** 菜单上，指向 **“新建”**，再单击 **“项目”**。  
  
3. 在中**项目类型**窗格中，选择新建项目对话框中的**BizTalk 项目**。 在模板窗格中选择**空的 BizTalk Server 项目**。  
  
4. 在中**名称**框中，键入**SWIFTProject**作为解决方案名称。  
  
5. 在中**位置**框中，键入 **\<*驱动器*\>: \labs**。  
