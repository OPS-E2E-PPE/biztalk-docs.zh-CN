...
|                    “服务器”                    |                                                                                                                                           建议的硬件要求                                                                                                                                            |                                                                                                                                                   软件要求                                                                                                                                                    |
|----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|             域控制器             |                                                                                                                                             -1 的网络适配器                                                                                                                                             |                                       Microsoft Windows Server 2012 R2 或 2012<br />-   Microsoft [!INCLUDE[btsAD](../../includes/btsad-md.md)] Server<br />-域名服务器 (DNS)                                       |
|           Microsoft SQL Server(s)            | -2 个网络适配器<br />可选：对于存储区域网络 (SAN) 磁盘中，选择所需的平均吞吐量、 峰值吞吐量和峰值吞吐量时间加上的硬盘空间的平均消息大小。 SAN 应分为三个驱动器： 数据、 事务日志和仲裁。 |                                                                        Microsoft Windows Server 2012 R2 或 2012<br />-   [!INCLUDE[SQLServer2008or2005](../../includes/sqlserver2008or2005-md.md)]                                                                         |
