...
1. 执行的自定义安装[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]选择以下功能：**业务规则引擎**并**SharePoint 适配器**。  

   > [!NOTE]
   >  不需要此安装其他功能。  

   > [!NOTE]
   >  在其中一个 BizTalk HTTP 前端服务器时执行配置，创建 BizTalk 组。  
