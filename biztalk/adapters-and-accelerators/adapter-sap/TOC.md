...
#### [教程 1：在 SharePoint 上提供来自 SAP 系统的数据](tutorial-1-presenting-data-from-an-sap-system-on-a-sharepoint-site.md)
##### [步骤 1：将 SAP 项目作为 WCF 服务发布](step-1-publish-the-sap-artifacts-as-a-wcf-service.md)
...
##### [步骤 1：修改 vPrev BizTalk 项目以调用 RFC](step-1-modify-the-vprev-biztalk-project-for-invoking-an-rfc.md)
...
##### [步骤 1：生成和部署 vPrev BizTalk 项目以发送 IDOC](step-1-build-and-deploy-the-vprev-biztalk-project-for-sending-an-idoc.md)
...
##### [步骤 1：生成和部署 vPrev BizTalk 项目来接收 IDOC](step-1-build-and-deploy-the-vprev-biztalk-project-for-receiving-an-idoc.md)
