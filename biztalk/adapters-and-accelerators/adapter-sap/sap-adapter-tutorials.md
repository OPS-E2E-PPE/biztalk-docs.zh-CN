...
---
# <a name="sap-adapter-tutorials"></a>SAP 适配器教程
## <a name="overview"></a>概述
中的第一个[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]教程包含如何在 Microsoft SharePoint 门户网站上显示从 SAP 系统的数据的分步演示。 其余部分[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]教程包含有关如何迁移使用以前的版本与当前的 SAP 适配器创建的 BizTalk 项目的详细的说明基于 WCF 的[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]。  
  
 除了教程中的主题[开发 BizTalk 应用程序](../../adapters-and-accelerators/adapter-sap/develop-biztalk-applications-using-the-sap-adapter.md)部分提供关于如何使用的详细的说明[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]与[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]。  
