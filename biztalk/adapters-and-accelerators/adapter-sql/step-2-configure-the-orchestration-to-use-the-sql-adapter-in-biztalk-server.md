...
---
# <a name="step-2-configure-the-orchestration-in-biztalk-server-administration-console-using-the-sql-adapter"></a>第 2 步：在使用 SQL 适配器的 BizTalk Server 管理控制台中配置业务流程
