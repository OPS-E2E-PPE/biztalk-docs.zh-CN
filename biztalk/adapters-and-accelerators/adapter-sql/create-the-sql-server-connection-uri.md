...
##  <a name="FailoverPartner"></a><span data-ttu-id="ac4cc-105">SQL 适配器的连接 URI</span><span class="sxs-lookup"><span data-stu-id="ac4cc-105">The Connection URI for the SQL Adapter</span></span>  
